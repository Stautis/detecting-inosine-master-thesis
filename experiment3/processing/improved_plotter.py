...
################################################################################
#
# This script generates the line plots seen in chapter 6.7.1. It calculates 
# descriptive statistics from current signals for each of the 9 positions in 
# the segments we compare. The plots are made with bokeh.
#
################################################################################
...
p2.line(con1_std_x, con1_std_y, line_width=4, line_color='#173F5F', legend_label="Inosine")
p2.line(con2_std_x, con2_std_y, line_width=2, line_color='#66ff00', legend_label="Adenine")
